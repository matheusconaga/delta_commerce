              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(
                      child: Column(
                        children: [
                          ...
                          Text("Notebook ASUS VivoBook Go 15 ",style: Apptext.Heading2, ),
                          SizedBox(height: Spacing.SpacingP,),
                          Text("R\$ 1.700,59", style: Apptext.Heading1.copyWith(color: Appcolors.accent),),
                          SizedBox(height: Spacing.SpacingP,),
                          Text("Parnaíba-PI", style: Apptext.Body1,),
                        ],
                      ),
                    ),
                    Padding(padding: EdgeInsetsGeometry.symmetric(vertical: Spacing.SpacingM),
                    child: Container(
                    ...
                    SizedBox(height: Spacing.SpacingP,),
                    Text("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam porttitor metus sed magna interdum, vel porta felis scelerisque. Sed lorem tortor, convallis quis eros ut, convallis faucibus purus. ",
                    style: Apptext.Body1,)
                  ],
                ),
              ),
